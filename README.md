...
### 1) Believe in yourself
  ...
  - Golden Rule: If you are tired, drink hot tea, walk 5k steps
  ...
  - Youtube motivation:
    ...
    - [Джейк отправляется на турнир. Начало турнира. HD](https://www.youtube.com/watch?v=m6rBFcf9W7E)
    - [Слежка за тренером в попытке вернуться в секцию. Никогда не сдавайся.](https://www.youtube.com/watch?v=pQWgfBewAYE)
...
### 2) Professional in Python programming language
  ...
  - [100+ Real-time Python Interview Questions and Answers [2023] | geekflare](https://geekflare.com/top-python-interview-questions/)
